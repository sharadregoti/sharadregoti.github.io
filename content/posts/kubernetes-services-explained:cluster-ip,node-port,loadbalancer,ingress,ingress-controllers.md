+++
title = 'Kubernetes Services Explained: Cluster IP, NodePort, Loadbalancer, Ingress, Ingress Controllers'
...
![Kubernetes Cluster](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/blog-architecture.drawio_(2).svg)
...
![Example Pod IP](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/pod-ip.png)
...
![Load Balancing between Pods in K8s using Service Resource](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/kubernetes-service-load-balancing.drawio.svg)
...
![clusterip-kubectl-service.png](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/clusterip-kubectl-service.png)
...
![Internal Communication Using Cluster IP Service](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/kubernetes-cluster-ip.svg)
...
![node-port-service.png](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/node-port-service.png)
...
![Exposing Application Using Nodeport Service](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/kubernetes-nodeport-service.svg)
...
![Load Balancer Service Example](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/load-balancer-ip.png)
...
![Service Superset](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/superset.svg)
...
![Exposing Application Using Load Balancer Service](/images/kubernetes-services-explained:cluster-ip,node-port,loadbalancer,ingress,ingress-controllers/production-setup.drawio.svg)
